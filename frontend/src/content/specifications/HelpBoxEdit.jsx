function HelpBoxEdit() {
    return (
        <>
            ...
            <h4 className="grey-text">Kolonner</h4>
            <p>
            ...
            <h4 className="grey-text">Gjenvinner</h4>
            ...
            <h4 className="grey-text">Styring</h4>
            ...
            <h4 className="grey-text">Kommentar</h4>
            <p>
                Fyll inn kommentar som er til for internt bruk.
            </p>

            <h4 className="grey-text">Slett rom</h4>
            <p>
