function HelpBoxEdit() {
    return (
        <>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Kolonner</h4>
            <p>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Kommentar</h4>
            <p>
                Fyll inn kommentar som er til for internt bruk.
            </p>

            <h4 className="text-grey-text dark:text-dark-grey-text">Slett rom</h4>
            <p>
