    ...
    return (
        <div className="fixed top-0 h-full w-full justify-center items-center z-[1000] bg-background-shade">
            <div className="w-full h-full flex flex-col justify-center items-center">
                <div className="bg-secondary-color dark:bg-dark-secondary-color flex flex-col p-5 w-[400px] h-[400px] justify-center items-center text-center rounded-lg border dark:border-dark-default-border-color border-default-border-color">
