function HelpBox() {
    return (
        <>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Tabell</h4>
            <p>
                Viser en oversikt over alle romtypene som er lagt inn i denne kravspsifikasjonen
            </p>
            <h4 className="text-grey-text dark:text-dark-grey-text">Nye romtyper</h4>
            <p>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Redigere romtyper</h4>
            <p>
