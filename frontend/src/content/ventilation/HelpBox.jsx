function HelpBox() {
    return (
        <>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Tilluft/avtrekk</h4>
            <p>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Kolonne "Rom"</h4>
            <p>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">System</h4>
            <p>
