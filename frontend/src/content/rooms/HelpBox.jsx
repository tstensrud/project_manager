function HelpBox() {
    return (
        <>
            <h3>Romliste</h3>
            <h4 className="text-grey-text dark:text-dark-grey-text">Legg til nytt rom</h4>
            <p>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Redigere rom</h4>
            <p>
            ...
            <h4 className="text-grey-text dark:text-dark-grey-text">Slette rom</h4>
            <p>
