                ...
                <div className="flex flex-1 justify-end items-center">
                    {
                        setCollapseAll && (
                            <div className="cursor-pointer flex items-center flex-row h-full pr-3" onClick={handleCollapseAll}>
                                <div className={`group flex p-1 h-full items-center justify-center border hover:dark:bg-dark-navbar-hover-bg-color rounded-lg dark:border-dark-accent-color border-primary-color transition duration-300 ${collapseAll && "rotate-180"}`}>
