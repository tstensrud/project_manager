...
function SubMenu({ menu }) {
    ...
    return (
        <div className="flex flex-col pt-1 pb-1">
            ...
            <div onClick={handleOpenMenu} className="group cursor-pointer flex justify-between flex-row w-full h-full items-center">
                <div className={`flex tracking-wide ${showMenu ? "text-primary-color dark:text-dark-primary-color":"text-grey-text dark:text-dark-grey-text"}  group-hover:text-primary-color group-hover:dark:text-dark-primary-color transition duration-300`}>
                    {menu.menuTitle}
                </div>
