                            ...
                            <div className="flex flex-col items-center justify-start pl-20 pr-20 h-full pt-10">
                                <form onSubmit={handleNewPasswordSubmit}>
                                    ...
                                    <div className="flex flex-col mt-3 justify-center">
                                        <div className="mb-5">
                                            <button className="border-2 border-dark-form-border-color bg-dark-form-background-color text-dark-primary-color rounded-3xl pt-2 pb-2 pl-5 pr-5 focus:border-dark-form-focus-border-color focus:outline-none hover:border-dark-form-element-hover" type="submit" disabled={!passwordMatch}>
                                                Fortsett
                                            </button>
                                        </div>
                                        <div className="h-10">
