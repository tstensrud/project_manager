function starIcon() {
  return (
<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="stroke-accent-color dark:stroke-dark-accent-color fill-none" viewBox="0 0 24 24">
