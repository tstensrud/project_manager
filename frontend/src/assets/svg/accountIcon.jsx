function accountIcon() {
  return (
    <svg className="stroke-accent-color dark:stroke-dark-accent-color fill-none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 2 24 24">
