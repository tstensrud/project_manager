...
def test():
    ...
    floors = dbo.get_building_floors("8dLbgOmLRqmNEjB5_8Esmw")
    for floor in floors:
        supply = dbo.sum_airflow_supply_floor_building("8dLbgOmLRqmNEjB5_8Esmw", floor)
        print(f"Supply for floor {floor} is {supply}")
